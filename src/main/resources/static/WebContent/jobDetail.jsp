...
6、熟悉基本的软件开发流程，有良好的沟通能力和团队合作能力。
    	...
    	<div class="row" style="margin-top:10px">
    		<div class="col-md-12 col-xs-12" style="padding-left:10px;">
    			<div style="float:left;margin:10px;padding-top:13px;">
    				<span class="glyphicon glyphicon-envelope" style="color:#3CB371;height:40px;font-size: 30px"></span>
    			</div>
    			<div class="detailblock">
    				<h3>简历投递<span style="color:#3CB371;">邮箱</span></h3>
    			</div>
    		</div>
    		<div class="col-md-12 col-xs-12" style="padding-left:70px;padding-top:20px">
    			<div style="color:#A9A9A9;font-size:17px">济南高新区 舜风路1006-5号</div>
    	...
    	<div class="row" style="margin-top:10px">
    		<div class="col-md-12 col-xs-12" style="padding-left:10px;">
    			<div style="float:left;margin:10px;padding-top:13px;">
    				<span class="glyphicon glyphicon-user" style="color:rgb(77,173,245);height:40px;font-size: 30px"></span>
    			</div>
    			<div class="detailblock">
    				<h3>所需<span style="color:rgb(77,173,245);">人数</span></h3>
    			</div>
    		</div>
    		<div class="col-md-12 col-xs-12" style="padding-left:70px;padding-top:20px">
    			<div style="color:#A9A9A9;font-size:17px">
    	...
    	<div class="row" style="margin-top:10px">
    		<div class="col-md-12 col-xs-12" style="padding-left:10px;">
    			<div style="float:left;margin:10px;padding-top:13px;">
    				<span class="glyphicon glyphicon-saved" style="color:#3CB371;height:40px;font-size: 30px"></span>
    			</div>
    			<div class="detailblock">
    				<h3>公司<span style="color:#3CB371;">介绍</span></h3>
    			</div>
    		</div>
    		<div class="col-md-12 col-xs-12" style="padding-left:70px;padding-top:20px">
    			<div style="color:#A9A9A9;font-size:17px">
